// <copyright file="CalculatorMHarisClient.cs" company="APIMatic">
// Copyright (c) APIMatic. All rights reserved.
// </copyright>
namespace CalculatorMHaris.Standard
{
    using System;
    ...
    using System.Net;
    using System.Text;
    using CalculatorMHaris.Standard.Authentication;
    ...
    /// </summary>
    public sealed class CalculatorMHarisClient : IConfiguration
    {
        ...
        private CalculatorMHarisClient(
        ...
        /// <summary>
        /// Creates an object of the CalculatorMHarisClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> CalculatorMHarisClient.</returns>
        internal static CalculatorMHarisClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("CALCULATOR_M_HARIS_STANDARD_ENVIRONMENT");
        ...
        {
            private Environment environment = CalculatorMHaris.Standard.Environment.Production;
            ...
            /// </summary>
            /// <returns>CalculatorMHarisClient.</returns>
            public CalculatorMHarisClient Build()
            {
                this.httpClient = new HttpClientWrapper(this.httpClientConfig.Build());

                return new CalculatorMHarisClient(
                    this.environment,
                    this.authManagers,
                    this.httpClient,
                    this.httpCallBack,
